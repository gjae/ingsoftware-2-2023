...
MIGRATION_MODULES = {"sites": "ingsoftware.contrib.sites.migrations"}
...
LOGIN_REDIRECT_URL = "users:dashboard.home"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "ingsoftware.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Equipo 1""", "soporte@fundvzla.xyz")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "ingsoftware.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "ingsoftware.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "ingsoftware.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "ingsoftware.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
